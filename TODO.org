...
** TODO Create experiment_text fixtures [0/2]
   - [ ] Go through experiment_controller for configurable strings
   - [ ] Create fixtures as appropriate

** TODO Fix what happens when no errors are corrected [0/1]
   - [ ] Should just say "nothing corrected"

** TODO Display bank on wait page?

** TODO Tax/disclosure functionality [0/2]
   - [ ] Check that disclosed amount is not negative or more than actually earned
   - [ ] Subtract taxes from bank

** TODO Audit selection [0/3]
