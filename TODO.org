...
* Wednesday, August 19
** TODO Enable lockdown functionality in admin/status [0/4]
   - [ ] Confirmation dialog
   - [ ] New action on admin controller
   - [ ] Lockdown method on experimental_session model
     - [ ] New locked_down field in model
     - [ ] Deletes unseen participants
     - [ ] Refuses to add new participants
...
** TODO Experimental session management page [1/6]
   - [X] Action "sessions"
   - [-] View "sessions"
   ...
   - [ ] Action "set_active_session"
     - [ ] Check no current active
     - [ ] call set active
     - [ ] redirect back
   - [-] Action "add_session"
     - [ ] Form for adding a session (just title for now)
     - [ ] partial
     - [X] empty div
     - [ ] ajax
     - [ ] ajax hide
   - [ ] Action "delete_session"
     - [ ] Refuse to delete sessions that have been used
       - [ ] Enforce in model
       - [ ] Write tests
   ...
   - [ ] Action "create_participants"
     - [ ] UI for create participants
       ...
       - [ ] ajax
       - [ ] ajax hide
     - [ ] Refuse on locked-down sessions
       - [ ] Enforce in model
       - [ ] Write tests
     - [ ] Also should work from status page
